...
ActiveRecord::Schema.define(version: 2020_05_19_225511) do
  ...
  create_table "channels", force: :cascade do |t|
    ...
    t.datetime "last_message_posted", null: false
  ...
  create_table "memberships", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.datetime "last_arrived", null: false
    t.datetime "last_departed", null: false
  ...
  create_table "users", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.integer "current_channel", default: 1
    t.string "focus", default: "1"
